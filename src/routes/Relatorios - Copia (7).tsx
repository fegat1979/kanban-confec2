// src/routes/Relatorios.tsx - FILTROS ULTRA COMPACTOS
            ...
            <div className="md:col-span-3">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-9 py-2.5 border rounded-xl text-sm focus:outline-none focus:border-blue-400"
                />
              </div>
            </div>
